...
class BaseNavigatorCommon(val list: ArrayList<SuperPagerAdapter.Struct>, val vp: ViewPager) : CommonNavigatorAdapter() {

    companion object {
        fun setUpWithPager(context: Context, lists: ArrayList<SuperPagerAdapter.Struct>, MagicIndicator: MagicIndicator, ViewPage: ViewPager) {
